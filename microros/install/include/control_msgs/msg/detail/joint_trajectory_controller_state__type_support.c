...
static rosidl_typesupport_introspection_c__MessageMember JointTrajectoryControllerState__rosidl_typesupport_introspection_c__JointTrajectoryControllerState_message_member_array[9] = {
  {
    "header",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, control_msgs, msg, JointTrajectoryControllerState)() {
  ...
  JointTrajectoryControllerState__rosidl_typesupport_introspection_c__JointTrajectoryControllerState_message_member_array[4].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, trajectory_msgs, msg, JointTrajectoryPoint)();
  JointTrajectoryControllerState__rosidl_typesupport_introspection_c__JointTrajectoryControllerState_message_member_array[6].members_ =
  ...
  JointTrajectoryControllerState__rosidl_typesupport_introspection_c__JointTrajectoryControllerState_message_member_array[7].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, trajectory_msgs, msg, MultiDOFJointTrajectoryPoint)();
  JointTrajectoryControllerState__rosidl_typesupport_introspection_c__JointTrajectoryControllerState_message_member_array[8].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, trajectory_msgs, msg, MultiDOFJointTrajectoryPoint)();
