...
#if defined(ESP32) || defined(TARGET_PORTENTA_H7_M7) || defined(WIO_TERMINAL) || defined(ARDUINO_NANO_RP2040_CONNECT)

#if defined(ESP32) || defined(TARGET_PORTENTA_H7_M7) || defined(WIO_TERMINAL)
#include <WiFi.h>
#include <WiFiUdp.h>
